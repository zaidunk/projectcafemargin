...
export default function AdminPanel() {
  ...
  async function addUser(e) {
    ...
    try {
      ...
      toast.error(err.response?.data?.detail || 'Gagal menambahkan user')
    }
  }
      ...
      <div className="space-y-5">
        ...
        {loading ? (
          ...
          <div className="card">
            ...
            {showAddCafe && (
              <form onSubmit={addCafe} className="bg-brand-50 border border-brand-200 rounded-xl p-4 mb-4 grid grid-cols-2 gap-3">
          ...
          <div className="card">
            ...
            {showAddUser && (
              <form onSubmit={addUser} className="bg-brand-50 border border-brand-200 rounded-xl p-4 mb-4 grid grid-cols-2 gap-3">
