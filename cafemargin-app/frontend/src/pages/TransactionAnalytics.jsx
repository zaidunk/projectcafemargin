...
import { Download, Trash2, FileSpreadsheet, AlertCircle, CheckCircle, Info } from 'lucide-react'
...
export default function TransactionAnalytics() {
  ...
  return (
    <AppLayout title={t('nav.transactions')}>
                  ...
                  <div className="card">
                    ...
                    <div className="space-y-2.5">
                      {paymentBreakdown.slice(0, 6).map((pm) => {
                        const total = paymentBreakdown.reduce((s, p) => s + p.total_revenue, 0)
                        const pct = total > 0 ? pm.total_revenue / total * 100 : 0
                        return (
