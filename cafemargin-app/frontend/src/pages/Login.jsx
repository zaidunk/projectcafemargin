      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-sm animate-fade-in">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            <div className="mb-7">
              <h2 className="text-2xl font-bold text-brand-900">{t('login.title')}</h2>
              <p className="text-brand-400 text-sm mt-1">Masukkan kredensial akun cafe Anda</p>
            </div>
            ...
            <div className="mt-5 p-3.5 bg-brand-50 rounded-xl border border-brand-100">
              <p className="text-[11px] text-brand-500 font-semibold uppercase tracking-wide mb-1.5">Demo Akun</p>
